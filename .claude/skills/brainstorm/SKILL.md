...
Help the user find a **sharp, finishable** idea with **clear verbs** and **felt
fantasy** — not a design doc the size of a novel.
...
2. **Explore** with open questions:
   ...
   - References (games, film, music) — **what to steal** vs **what to avoid**
3. **Synthesize** into:
   - **One-line pitch**
